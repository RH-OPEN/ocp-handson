...
** xref:111_Installing-OpenShift-IPI.adoc[1. Installing OpenShift (IPI)]
** xref:112_Deploying-OpenShift-AI-3.0.adoc[2. Deploying OpenShift AI 3.0]
** xref:83-module-03-to-the-moon.adoc[3. OpenShift AI 3 を試す]