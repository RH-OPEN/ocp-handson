...
Webコンソール右上の「+」アイコンをクリックして、「コンテナーイメージ」を選択します。
...
https://docs.redhat.com/ja/documentation/openshift_container_platform/4.20/html/images/images-imagestream-import-images-image-streams#images-imagestream-import-images-private-registry_image-streams-managing[公式ガイド]
にある OpenShift CLIの　`oc import-image` コマンドを利用して、アプリケーションを更新できます。
