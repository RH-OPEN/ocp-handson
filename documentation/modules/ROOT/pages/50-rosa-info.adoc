...
ROSAクラスターからAWS Security Token Service (STS)によるAmazon EFS, Amazon ECRの利用方法です。

* https://rheb.hatenablog.com/entry/202412-rosa-efs-ecr[ROSAでのAWS STSによるAmazon EFS/ECRの利用]
