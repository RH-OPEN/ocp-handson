...
* https://rh-open.github.io/ocp-handson/openshift-services/_images/rosa/pdf/2025-openshift-virt-aws-public.pdf[OpenShift Virtualization on AWS with ROSA/Self-Managed OpenShiftの紹介資料(PDFファイル)]
